...
# DICCIONARIO DE AÑOS Y CODIGOS DE LA ENAPRES
# -------------------------------------------
YEAR_MAP = {
    "2023": {"codigo": 903, "year": 2023},
    "2022": {"codigo": 785, "year": 2022},
    "2021": {"codigo": 761, "year": 2021},
    "2020": {"codigo": 736, "year": 2020},
    "2019": {"codigo": 684, "year": 2019},
    "2018": {"codigo": 626, "year": 2018},
    "2017": {"codigo": 596, "year": 2017},
    "2016": {"codigo": 544, "year": 2016},
    "2015": {"codigo": 495, "year": 2015},
    "2014": {"codigo": 438, "year": 2014},
    "2013": {"codigo": 406, "year": 2013},
    "2012": {"codigo": 325, "year": 2012},
    "2011": {"codigo": 293, "year": 2011},
    "2010": {"codigo": 266, "year": 2010},
}
...
def _download_and_extract_one(
    ...
    codigo_enapres = YEAR_MAP[anio]["codigo"]
    year_enapres = YEAR_MAP[anio]["year"]

    # Construir URL
    url = f"https://proyectos.inei.gob.pe/iinei/srienaho/descarga/DBF/{codigo_enapres}-Modulo{modulo}.zip"
    
    # Rutas y nombres
    os.makedirs(output_dir, exist_ok=True)
    zip_filename = f"modulo_{modulo}_{year_enapres}.zip"
    ...
    try:
        with requests.get(url, stream=True) as r:
            if r.status_code == 200:
                ...
                if descomprimir:
                    extract_dir = os.path.join(output_dir, f"modulo_{modulo}_{year_enapres}_extract")
                    ...
                    try:
                        ...
                        if only_dta:
                            ...
                            dta_dir = os.path.join(output_dir, f"modulo_{modulo}_{year_enapres}_dta_only")
