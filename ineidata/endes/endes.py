...
# DICCIONARIO DE AÑOS Y CODIGOS DE LA ENDES
# -----------------------------------------
YEAR_MAP = {
    "2023": {"codigo": 910, "year": 2023},
    "2022": {"codigo": 786, "year": 2022},
    "2021": {"codigo": 760, "year": 2021},
    "2020": {"codigo": 739, "year": 2020},
    "2019": {"codigo": 691, "year": 2019},
    "2018": {"codigo": 638, "year": 2018},
    "2017": {"codigo": 605, "year": 2017},
    "2016": {"codigo": 548, "year": 2016},
    "2015": {"codigo": 504, "year": 2015},
    "2014": {"codigo": 441, "year": 2014},
    "2013": {"codigo": 407, "year": 2013},
    "2012": {"codigo": 323, "year": 2012},
    "2011": {"codigo": 290, "year": 2011},
    "2010": {"codigo": 260, "year": 2010},
    "2009": {"codigo": 238, "year": 2009},
    "2008": {"codigo": 209, "year": 2008},
    "2007": {"codigo": 194, "year": 2007},
    "2006": {"codigo": 183, "year": 2006},
    "2005": {"codigo": 150, "year": 2005},
    "2004": {"codigo": 120, "year": 2004},
    "2004": {"codigo":  35, "year": 2000},
    "2004": {"codigo":  32, "year": 1996},
}




def _download_and_extract_one_endes(
    anio: str,
    modulo: str,
    output_dir: str,
    chunk_size: int,
    ...
    if anio not in YEAR_MAP:
        raise ValueError(f"Año {anio} no está en la lista de ENDES soportados.")

    codigo_endes = YEAR_MAP[anio]["codigo"]
    year_endes = YEAR_MAP[anio]["year"]

    # Construir URL
    url = f"https://proyectos.inei.gob.pe/iinei/srienaho/descarga/STATA/{codigo_endes}-Modulo{modulo}.zip"
    
    # Rutas y nombres
    os.makedirs(output_dir, exist_ok=True)
    zip_filename = f"modulo_{modulo}_{year_endes}.zip"
    ...
    try:
        with requests.get(url, stream=True) as r:
            if r.status_code == 200:
                ...
                if descomprimir:
                    extract_dir = os.path.join(output_dir, f"modulo_{modulo}_{year_endes}_extract")
                    ...
                    try:
                        ...
                        if only_dta:
                            ...
                            dta_dir = os.path.join(output_dir, f"modulo_{modulo}_{year_endes}_dta_only")
...
def endesdata(
    ...
    """
    Función principal para descargar los módulos de la ENDES.
    ...
    if parallel_downloads:
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            for anio, modulo in tasks:
                fut = executor.submit(
                    _download_and_extract_one_endes,
                    anio=anio,
                    modulo=modulo,
